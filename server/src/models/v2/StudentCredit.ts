...
export interface IStudentCredit extends Document {
  ...
  feeMonth?: Date;  // Always stored as 1st of month at midnight UTC, matching FeeRecordV2.feeMonth
  dueDate?: Date;
  paidDate?: Date;
...
const StudentCreditSchema = new Schema<IStudentCredit>(
  {
    ...
    feeMonth: {
      type: Date  // Always stored as 1st of month at midnight UTC, matching FeeRecordV2.feeMonth
    },
    dueDate: {
      type: Date
    },
...
const StudentCreditV2 = mongoose.model<IStudentCredit>('StudentCredit', StudentCreditSchema);

export default StudentCreditV2;
